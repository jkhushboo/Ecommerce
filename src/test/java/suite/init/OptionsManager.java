...
public class OptionsManager {
	...
	private EdgeOptions optionedge;
	...
	public InternetExplorerOptions getIeOptions() {
		...
		//WebDriverManager.iedriver().setup();
		 ...
		 WebdriverConstants.IEDRIVER_PATH);
		return optionie;
	}
	
	public EdgeOptions getEdgeOptions() {
		//System.setProperty("webdriver.edge.driver", WebdriverConstants.EDGEDRIVER_PATH);
		optionedge = new EdgeOptions();
